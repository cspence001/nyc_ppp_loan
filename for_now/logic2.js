...
//     case "ind1":
    ...
    // if (selection == "Manufacturing") {
        ...
        var jobsData = {
            "ind1": [
                { indexLabel: LoanRanges[0], y: ind1jobscount_sum[0]},
                { indexLabel: LoanRanges[1], y: ind1jobscount_sum[1]},
                { indexLabel: LoanRanges[2], y: ind1jobscount_sum[2]},
                { indexLabel: LoanRanges[3], y: ind1jobscount_sum[3]},
                { indexLabel: LoanRanges[4], y: ind1jobscount_sum[4]}
            ],
            "ind2": [
            ...
            "ind3": [
                { indexLabel: LoanRanges[0], y: ind3jobscount_sum[0]},
                { indexLabel: LoanRanges[1], y: ind3jobscount_sum[1]},
                { indexLabel: LoanRanges[2], y: ind3jobscount_sum[2]},
                { indexLabel: LoanRanges[3], y: ind3jobscount_sum[3]},
                { indexLabel: LoanRanges[4], y: ind3jobscount_sum[4]}
            ],
            "ind4": [
                { indexLabel: LoanRanges[0], y: ind4jobscount_sum[0]},
                { indexLabel: LoanRanges[1], y: ind4jobscount_sum[1]},
                { indexLabel: LoanRanges[2], y: ind4jobscount_sum[2]},
                { indexLabel: LoanRanges[3], y: ind4jobscount_sum[3]},
                { indexLabel: LoanRanges[4], y: ind4jobscount_sum[4]}
            ],
            "ind5": [
                { indexLabel: LoanRanges[0], y: ind5jobscount_sum[0]},
                { indexLabel: LoanRanges[1], y: ind5jobscount_sum[1]},
                { indexLabel: LoanRanges[2], y: ind5jobscount_sum[2]},
                { indexLabel: LoanRanges[3], y: ind5jobscount_sum[3]},
                { indexLabel: LoanRanges[4], y: ind5jobscount_sum[4]}
            ],
            "ind6": [
                { indexLabel: LoanRanges[0], y: ind6jobscount_sum[0]},
                { indexLabel: LoanRanges[1], y: ind6jobscount_sum[1]},
                { indexLabel: LoanRanges[2], y: ind6jobscount_sum[2]},
                { indexLabel: LoanRanges[3], y: ind6jobscount_sum[3]},
                { indexLabel: LoanRanges[4], y: ind6jobscount_sum[4]}
            ],
            "ind7": [
                { indexLabel: LoanRanges[0], y: ind7jobscount_sum[0]},
                { indexLabel: LoanRanges[1], y: ind7jobscount_sum[1]},
                { indexLabel: LoanRanges[2], y: ind7jobscount_sum[2]},
                { indexLabel: LoanRanges[3], y: ind7jobscount_sum[3]},
                { indexLabel: LoanRanges[4], y: ind7jobscount_sum[4]}
            ],
            "ind8": [
                { indexLabel: LoanRanges[0], y: ind8jobscount_sum[0]},
                { indexLabel: LoanRanges[1], y: ind8jobscount_sum[1]},
                { indexLabel: LoanRanges[2], y: ind8jobscount_sum[2]},
                { indexLabel: LoanRanges[3], y: ind8jobscount_sum[3]},
                { indexLabel: LoanRanges[4], y: ind8jobscount_sum[4]}
            ],
            "ind9": [
                { indexLabel: LoanRanges[0], y: ind9jobscount_sum[0]},
                { indexLabel: LoanRanges[1], y: ind9jobscount_sum[1]},
                { indexLabel: LoanRanges[2], y: ind9jobscount_sum[2]},
                { indexLabel: LoanRanges[3], y: ind9jobscount_sum[3]},
                { indexLabel: LoanRanges[4], y: ind9jobscount_sum[4]}
            ],
            "ind10": [
                { indexLabel: LoanRanges[0], y: ind10jobscount_sum[0]},
                { indexLabel: LoanRanges[1], y: ind10jobscount_sum[1]},
                { indexLabel: LoanRanges[2], y: ind10jobscount_sum[2]},
                { indexLabel: LoanRanges[3], y: ind10jobscount_sum[3]},
