...
//     case "ind1":
    ...
    // if (selection == "Manufacturing") {
        ...
        // if (selection == "Other Services (except Public Administration)") {
            ...
            console.log(ind11loanRanges_length);
        ...
        // if (selection == "Arts, Entertainment, and Recreation") {
            ...
            console.log(ind12loanRanges_length);
        ...
        // if (selection == "Retail Trade") {
            ...
            console.log(ind13loanRanges_length);
        ...
        // if (selection == "Real Estate Rental and Leasing") {
            ...
            console.log(ind14loanRanges_length);
        ...
        // if (selection == "Transportation and Warehousing") {
            ...
            console.log(ind15loanRanges_length);
        ...
        // if (selection == "Public Administration") {
            ...
            console.log(ind16loanRanges_length);
        ...
        // if (selection == "Agriculture, Forestry, Fishing and Hunting") {
            ...
            console.log(ind17loanRanges_length);
        ...
        // if (selection == "Utilities") {
            ...
            console.log(ind18loanRanges_length);
        ...
        // if (selection == "Management of Companies and Enterprises") {
            ...
            console.log(ind19loanRanges_length);
        ...
        var indLoansCountRangeb = (ind1loanRanges_length[1] + ind2loanRanges_length[1] + ind3loanRanges_length[1] + ind4loanRanges_length[1] + ind5loanRanges_length[1] + ind6loanRanges_length[1] + ind7loanRanges_length[1] + ind8loanRanges_length[1] + ind9loanRanges_length[1] + ind10loanRanges_length[1] + ind11loanRanges_length[1] + ind12oanRanges_length[1] + ind13loanRanges_length[1] + ind14loanRanges_length[1] + ind15loanRanges_length[1] + ind16loanRanges_length[1] + ind17loanRanges_length[1] + ind18loanRanges_length[1] + ind19loanRanges_length[1] + ind20loanRanges_length[1])
        ...
        var ind20LoanPercentB = (((ind120oanRanges_length[1])/ind20jobstotallist.length)* 100)
    ...
    var dataPoints3 = [];
        ...
        var ind1TableData = [
            ...
            {"Industry" : (industrylist[11]), "Loan Range" : (LoanRanges[0]), "# of Loans" : (ind12loanRanges_length[0]), "% of Loans Industry" : (ind12LoanPercentA.toFixed(2)), "% of Loan Range All Industry in Range" : (ind12LoanPercentAofAllinA.toFixed(2)), "% of All Loans": (ind12LoanPercentAofAllLoans.toFixed(2)), "# of Jobs Retained": (ind12jobscount_sum[0]), "% of Jobs Retained Industry" : (ind12JobPercentA.toFixed(2)), "% of Jobs Retained All Industry in Range" : (ind12JobPercentAofAllinA.toFixed(2)), "% of All Jobs Retained" : (ind12JobPercentAofAllLoans.toFixed(2))},
            {"Industry" : " ", "Loan Range" : (LoanRanges[1]), "# of Loans" : (ind12loanRanges_length[1]), "% of Loans Industry" : (ind12LoanPercentB.toFixed(2)), "% of Loan Range All Industry in Range" : (ind12LoanPercentBofAllinB.toFixed(2)), "% of All Loans": (ind12LoanPercentBofAllLoans.toFixed(2)), "# of Jobs Retained": (ind12jobscount_sum[1]), "% of Jobs Retained Industry" : (ind12JobPercentB.toFixed(2)), "% of Jobs Retained All Industry in Range" : (ind12JobPercentBofAllinB.toFixed(2)), "% of All Jobs Retained" : (ind12JobPercentBofAllLoans.toFixed(2))},
            {"Industry" : " ", "Loan Range" : (LoanRanges[2]), "# of Loans" : (ind12loanRanges_length[2]), "% of Loans Industry" : (ind12LoanPercentC.toFixed(2)), "% of Loan Range All Industry in Range" : (ind12LoanPercentCofAllinC.toFixed(2)), "% of All Loans": (ind12LoanPercentCofAllLoans.toFixed(2)), "# of Jobs Retained": (ind12jobscount_sum[2]), "% of Jobs Retained Industry" : (ind12JobPercentC.toFixed(2)), "% of Jobs Retained All Industry in Range" : (ind12JobPercentCofAllinC.toFixed(2)), "% of All Jobs Retained" : (ind12JobPercentCofAllLoans.toFixed(2))},
            {"Industry" : " ", "Loan Range" : (LoanRanges[3]), "# of Loans" : (ind12loanRanges_length[3]), "% of Loans Industry" : (ind12LoanPercentD.toFixed(2)), "% of Loan Range All Industry in Range" : (ind12LoanPercentDofAllinD.toFixed(2)), "% of All Loans": (ind12LoanPercentDofAllLoans.toFixed(2)), "# of Jobs Retained": (ind12jobscount_sum[3]), "% of Jobs Retained Industry" : (ind12JobPercentD.toFixed(2)), "% of Jobs Retained All Industry in Range" : (ind12JobPercentDofAllinD.toFixed(2)), "% of All Jobs Retained" : (ind12JobPercentDofAllLoans.toFixed(2))},
            {"Industry" : " ", "Loan Range" : (LoanRanges[4]), "# of Loans" : (ind12loanRanges_length[4]), "% of Loans Industry" : (ind12LoanPercentE.toFixed(2)), "% of Loan Range All Industry in Range" : (ind12LoanPercentEofAllinE.toFixed(2)), "% of All Loans": (ind12LoanPercentEofAllLoans.toFixed(2)), "# of Jobs Retained": (ind12jobscount_sum[4]), "% of Jobs Retained Industry" : (ind12JobPercentE.toFixed(2)), "% of Jobs Retained All Industry in Range" : (ind12JobPercentEofAllinE.toFixed(2)), "% of All Jobs Retained" : (ind12JobPercentEofAllLoans.toFixed(2))},
            {"Industry" : (industrylist[12]), "Loan Range" : (LoanRanges[0]), "# of Loans" : (ind13loanRanges_length[0]), "% of Loans Industry" : (ind13LoanPercentA.toFixed(2)), "% of Loan Range All Industry in Range" : (ind13LoanPercentAofAllinA.toFixed(2)), "% of All Loans": (ind13LoanPercentAofAllLoans.toFixed(2)), "# of Jobs Retained": (ind13jobscount_sum[0]), "% of Jobs Retained Industry" : (ind13JobPercentA.toFixed(2)), "% of Jobs Retained All Industry in Range" : (ind13JobPercentAofAllinA.toFixed(2)), "% of All Jobs Retained" : (ind13JobPercentAofAllLoans.toFixed(2))},
            {"Industry" : " ", "Loan Range" : (LoanRanges[1]), "# of Loans" : (ind13loanRanges_length[1]), "% of Loans Industry" : (ind13LoanPercentB.toFixed(2)), "% of Loan Range All Industry in Range" : (ind13LoanPercentBofAllinB.toFixed(2)), "% of All Loans": (ind13LoanPercentBofAllLoans.toFixed(2)), "# of Jobs Retained": (ind13jobscount_sum[1]), "% of Jobs Retained Industry" : (ind13JobPercentB.toFixed(2)), "% of Jobs Retained All Industry in Range" : (ind13JobPercentBofAllinB.toFixed(2)), "% of All Jobs Retained" : (ind13JobPercentBofAllLoans.toFixed(2))},
            {"Industry" : " ", "Loan Range" : (LoanRanges[2]), "# of Loans" : (ind13loanRanges_length[2]), "% of Loans Industry" : (ind13LoanPercentC.toFixed(2)), "% of Loan Range All Industry in Range" : (ind13LoanPercentCofAllinC.toFixed(2)), "% of All Loans": (ind13LoanPercentCofAllLoans.toFixed(2)), "# of Jobs Retained": (ind13jobscount_sum[2]), "% of Jobs Retained Industry" : (ind13JobPercentC.toFixed(2)), "% of Jobs Retained All Industry in Range" : (ind13JobPercentCofAllinC.toFixed(2)), "% of All Jobs Retained" : (ind13JobPercentCofAllLoans.toFixed(2))},
            {"Industry" : " ", "Loan Range" : (LoanRanges[3]), "# of Loans" : (ind13loanRanges_length[3]), "% of Loans Industry" : (ind13LoanPercentD.toFixed(2)), "% of Loan Range All Industry in Range" : (ind13LoanPercentDofAllinD.toFixed(2)), "% of All Loans": (ind13LoanPercentDofAllLoans.toFixed(2)), "# of Jobs Retained": (ind13jobscount_sum[3]), "% of Jobs Retained Industry" : (ind13JobPercentD.toFixed(2)), "% of Jobs Retained All Industry in Range" : (ind13JobPercentDofAllinD.toFixed(2)), "% of All Jobs Retained" : (ind13JobPercentDofAllLoans.toFixed(2))},
            ...
            {"Industry" : (industrylist[18]), "Loan Range" : (LoanRanges[0]), "# of Loans" : (ind19loanRanges_length[0]), "% of Loans Industry" : (ind19LoanPercentA.toFixed(2)), "% of Loan Range All Industry in Range" : (ind19LoanPercentAofAllinA.toFixed(2)), "% of All Loans": (ind19LoanPercentAofAllLoans.toFixed(2)), "# of Jobs Retained": (ind19jobscount_sum[0]), "% of Jobs Retained Industry" : (ind19JobPercentA.toFixed(2)), "% of Jobs Retained All Industry in Range" : (ind19JobPercentAofAllinA.toFixed(2)), "% of All Jobs Retained" : (ind19JobPercentAofAllLoans.toFixed(2))},
            {"Industry" : " ", "Loan Range" : (LoanRanges[1]), "# of Loans" : (ind19loanRanges_length[1]), "% of Loans Industry" : (ind19LoanPercentB.toFixed(2)), "% of Loan Range All Industry in Range" : (ind19LoanPercentBofAllinB.toFixed(2)), "% of All Loans": (ind19LoanPercentBofAllLoans.toFixed(2)), "# of Jobs Retained": (ind19jobscount_sum[1]), "% of Jobs Retained Industry" : (ind19JobPercentB.toFixed(2)), "% of Jobs Retained All Industry in Range" : (ind19JobPercentBofAllinB.toFixed(2)), "% of All Jobs Retained" : (ind19JobPercentBofAllLoans.toFixed(2))},
            ...
            {"Industry" : " ", "Loan Range" : (LoanRanges[3]), "# of Loans" : (ind19loanRanges_length[3]), "% of Loans Industry" : (ind19LoanPercentD.toFixed(2)), "% of Loan Range All Industry in Range" : (ind19LoanPercentDofAllinD.toFixed(2)), "% of All Loans": (ind19LoanPercentDofAllLoans.toFixed(2)), "# of Jobs Retained": (ind19jobscount_sum[3]), "% of Jobs Retained Industry" : (ind19JobPercentD.toFixed(2)), "% of Jobs Retained All Industry in Range" : (ind19JobPercentDofAllinD.toFixed(2)), "% of All Jobs Retained" : (ind19JobPercentDofAllLoans.toFixed(2))},
            {"Industry" : " ", "Loan Range" : (LoanRanges[4]), "# of Loans" : (ind19loanRanges_length[4]), "% of Loans Industry" : (ind19LoanPercentE.toFixed(2)), "% of Loan Range All Industry in Range" : (ind19LoanPercentEofAllinE.toFixed(2)), "% of All Loans": (ind19LoanPercentEofAllLoans.toFixed(2)), "# of Jobs Retained": (ind19jobscount_sum[4]), "% of Jobs Retained Industry" : (ind19JobPercentE.toFixed(2)), "% of Jobs Retained All Industry in Range" : (ind19JobPercentEofAllinE.toFixed(2)), "% of All Jobs Retained" : (ind19JobPercentEofAllLoans.toFixed(2))},
            {"Industry" : (industrylist[19]), "Loan Range" : (LoanRanges[0]), "# of Loans" : (ind20loanRanges_length[0]), "% of Loans Industry" : (ind20LoanPercentA.toFixed(2)), "% of Loan Range All Industry in Range" : (ind20LoanPercentAofAllinA.toFixed(2)), "% of All Loans": (ind20LoanPercentAofAllLoans.toFixed(2)), "# of Jobs Retained": (ind20jobscount_sum[0]), "% of Jobs Retained Industry" : (ind20JobPercentA.toFixed(2)), "% of Jobs Retained All Industry in Range" : (ind20JobPercentAofAllinA.toFixed(2)), "% of All Jobs Retained" : (ind20JobPercentAofAllLoans.toFixed(2))},
            {"Industry" : " ", "Loan Range" : (LoanRanges[1]), "# of Loans" : (ind20loanRanges_length[1]), "% of Loans Industry" : (ind20LoanPercentB.toFixed(2)), "% of Loan Range All Industry in Range" : (ind20LoanPercentBofAllinB.toFixed(2)), "% of All Loans": (ind20LoanPercentBofAllLoans.toFixed(2)), "# of Jobs Retained": (ind20jobscount_sum[1]), "% of Jobs Retained Industry" : (ind20JobPercentB.toFixed(2)), "% of Jobs Retained All Industry in Range" : (ind20JobPercentBofAllinB.toFixed(2)), "% of All Jobs Retained" : (ind20JobPercentBofAllLoans.toFixed(2))},
            {"Industry" : " ", "Loan Range" : (LoanRanges[2]), "# of Loans" : (ind20loanRanges_length[2]), "% of Loans Industry" : (ind20LoanPercentC.toFixed(2)), "% of Loan Range All Industry in Range" : (ind20LoanPercentCofAllinC.toFixed(2)), "% of All Loans": (ind20LoanPercentCofAllLoans.toFixed(2)), "# of Jobs Retained": (ind20jobscount_sum[2]), "% of Jobs Retained Industry" : (ind20JobPercentC.toFixed(2)), "% of Jobs Retained All Industry in Range" : (ind20JobPercentCofAllinC.toFixed(2)), "% of All Jobs Retained" : (ind20JobPercentCofAllLoans.toFixed(2))},
